...
interface TSelectSimpleProps<T = any> {
  id?: string;
  label: string;
  dalalist: T[];
  className?: string;
...
const TSelectSimple = forwardRef<HTMLButtonElement, TSelectSimpleProps>(
  (
    {
      id,
      label,
...
TSelectSimple.displayName = "TSelectSimple";

export default TSelectSimple;
